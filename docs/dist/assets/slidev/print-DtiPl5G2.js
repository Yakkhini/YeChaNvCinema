import{d as _,_ as h,y as u,b as a,e as t,x as s,A as r,F as f,Z as v,o as n,$ as g,l as x,g as b}from"../modules/vue-BkAWdxgR.js";import{e as y,h as N,c as m,b as k}from"../index-DoNEmNjy.js";import{N as w}from"./NoteDisplay-rM4nC36Y.js";import"../modules/shiki-CJh9h4kK.js";const D={id:"page-root"},L={class:"m-4"},T={class:"mb-10"},V={class:"text-4xl font-bold mt-2"},B={class:"opacity-50"},C={class:"text-lg"},H={class:"font-bold flex gap-2"},M={class:"opacity-50"},S=t("div",{class:"flex-auto"},null,-1),A={key:0,class:"border-main mb-8"},F=_({__name:"print",setup($){const{slides:d,total:p}=y();h(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
